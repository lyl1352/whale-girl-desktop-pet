...
| 🖲️ **右键菜单** | 在她身上右键：设置 / 漫游范围 / 鼠标穿透 / 开机自启 / 退出 |
...
动画节奏不对、气泡文案不同、少个按钮。这里的做法是**不改原版一行**：
...
│  · vendor/dsh-whale-girl-pet.client.js   ← 原版，未改一行     │
└─────────────────────────────────────────────────────────────┘
```
...
| 双击 | 摸头 |
| 拖动 | 拖着她走（会播被拖拽的动画） |
| **右键** | 弹出菜单：桌宠设置 / 漫游范围 / 鼠标穿透 / 开机自启 / 退出 |
...
- 高清素材母版（1200×1200）原项目需另行下载，本仓库用的是随包分发的 360×360 版本
...
（MIT，Copyright (c) 2026 dsh-whale-girl-pet contributors），**原样使用，未改一行**。
